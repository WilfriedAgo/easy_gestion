    ...
    switch($_REQUEST['pg']){
        ...
        case 'addMember' :
            ...
            if (!empty($_FILES['photo']['name'])){
                ...
                if ($_REQUEST['sexe'] == 1 ) $image_uploader = 'assets/images_uploader/members_images/user_female.png';
                        else $image_uploader = 'assets/images_uploader/members_images/user_male.png';
            }
        break;
